<template>
<div>
        <section style="margin-top:-60px;margin-left:200px"  class="px-4 py-12 mx-auto max-w-7xl">
  <div class="flex flex-wrap items-center justify-between mb-2 space-y-1">
    <h2 class="text-xl font-semibold text-gray-900">分析概述</h2>
    <label>
  ...
  <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
    <div class="p-6 card">
      ...
      <p class="text-sm leading-none text-gray-600">支付买家数</p>
    </div>
    <div class="p-6 card">
      <div class="flex items-start justify-between">
      ...
      <p class="text-sm leading-none text-gray-600">评论</p>
    </div>
    <div class="p-6 card">
      <div class="flex items-start justify-between">
      ...
      <p class="text-sm leading-none text-gray-600">访客数</p>
    </div>
    <div class="p-6 card">
      <div class="flex items-start justify-between">
      ...
      <p class="text-sm leading-none text-gray-600">用户</p>
