<!--  -->
<template>
  <footer class="pt-14  w-full" >
     <div class="bg-white pt-4 sm:pt-10 lg:pt-12" style=" background:rgb(40,40,40)">
  <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-center  gap-4 ">
      <!-- nav - start -->
      <nav class="flex flex-wrap justify-center md:justify-start gap-x-4 md:gap-6">
    ...
    <div class="text-gray-400 text-sm text-center py-4">© 2021 - Present Flowrift. All rights reserved.</div>
  </footer>
</div>

      <el-backtop
        target=".mainBox"
        v-if="$route.path.includes('/dataRadar/dataSearch/result')"
      >
